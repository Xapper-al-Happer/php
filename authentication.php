    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.html" class="navbar-brand headerFont text-lg">Student Voting System</a>
        </div>
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          <?php
                      ...
                      else
                      {
                        ...
                        {
                          $error="Sorry! Auth Failed ";
                          
                          echo "<p class='alert alert-danger'><strong>$error</strong></p>";

                          echo "<p class='normalFont text-primary'><strong>Your Combination of UserName and Password is In-correct. Please contact the developer of system.</strong> </p>";
