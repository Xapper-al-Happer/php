    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg">Student Voting System</a>
        </div>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Mr Adam {English}</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Mr Jose {Math}</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Mr Kunal {Science}</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Mr Ahmad {DT}</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Mr Zhandong Huang {Chinese}</strong><br>";
                  echo "
                  <div class='progress'>
